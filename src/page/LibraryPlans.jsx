...
const LibraryPlans = () => {
    return (
        <div className='mt-10 text-center'>
            ...
            <div className="card w-64 md:w-96 shadow-xl rounded-none max-h-[450px] mb-5" data-aos="zoom-in-right">
            ...
            <div className="card w-64 md:w-96 shadow-xl rounded-none max-h-[450px] mb-5" data-aos="zoom-in-down">
            ...
            <div className="card w-64 md:w-96 shadow-xl rounded-none max-h-[450px]" data-aos="zoom-in-left">
