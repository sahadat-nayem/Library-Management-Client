        ...
        <div className="min-h-screen flex justify-center items-center mt-10">
            ...
            <div className="card bg-base-100 w-full max-w-lg rounded-none shrink-0 p-10">
                ...
                <form className="card-body" onSubmit={handleSubmit}>
                    ...
                    <input type="email" name='email' placeholder="Enter your email address" className="input input-bordered bg-gray-100" ref={emailRef} required />
                    </div>
                    <div className="form-control relative">
                    <label className="label">
                        <span className="label-text font-semibold">Password</span>
                    </label>
                    <input type={showPassword ? 'text' : 'password'} name='password' placeholder="Enter your password" className="input input-bordered bg-gray-100" required />
